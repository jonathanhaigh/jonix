/*
 * File adapted from pcidatabase.com
 */
...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Sat May  9 15:40:54 PDT 2009
...
#ifndef _PCI_DEV_INFO_H
#define _PCI_DEV_INFO_H

typedef struct {
	uint16_t    vendor_id;
	char        *vendor_short;
	char        *vendor_long;
}  __attribute__((__packed__)) pci_vendor_id_record_t;

pci_vendor_id_record_t  pci_vendor_ids[] = {
	...
	{ 0x102F, "A305-S6905", "Toshiba America" },
...
#define	PCI_VENDOR_IDS_LEN  (sizeof(pci_vendor_ids)/sizeof(pci_vendor_id_record_t))
...
typedef struct {
	...
	char        *name;
	char        *desc;
} __attribute__((__packed__)) pci_dev_id_record_t;

pci_dev_id_record_t pci_dev_ids[] = {
	...
	{ 0x1274, 0x5880, "5880x", "Soundblaster" },
	{ 0x1274, 0x9876, "", "" },
	...
	{ 0x8086, 0x1227, "82801db ich8", "LAN Controller with 82562EM/EX PHY	PCI" },
	...
	{ 0x8086, 0x266D, "82801I", " Intel 82801GB ICH7 - High Definition Audio Controller [A-1]" },
	...
	{ 0x8086, 0x29A4, "Intel DP965LT", "The Intel Management Engine provides thermal management for Intel Desktop Boards." },
	...
	{ 0x8086, 0x8086, "HDAUDIO\\FUNC_01&VEN_8086&DEV_2802&SUBSYS_80860101&", "PCI\\VEN_8086&DEV_24**&SUBSYS_47428086&REV_02\\3&61AAA01&0&FB	28" },
	...
	{ 0x15DD, 0x7680, "*7662", "SIGMATEL STAC 92XX C-Major HD Audio" },
	{ 0x15DD, 0x7690, "9200", "9200 HD Audio CODEC" },
	...
	{ 0x1814, 0x0201, " PCI\\VEN_1814&DEV_0201&SUBSYS_68331460&REV_01\\3&26", "Ralink Chipset 802.11b/g WLAN Card" },
	...
	{ 0x14F1, 0x2C06, "1003", "HDAUDIO Soft Data fax Modem with SmartPC" },
	...
	{ 0x14F1, 0x5045, "1179FF312", "Conextant High Definition Audio-Venice 5045" },
	...
	{ 0x1971, 0x0001, "PCI\\VEN_1971&DEV_0000&SUBSYS_00021028&REV_00\\4&2E8", "AGEIA PhysX 100 Series PCI Express Card" },
	...
	{ 0x0A5C, 0x2100, " ", "Broadcom Bluetooth 2.0+eDR USB dongle" },
	...
	{ 0x0A5C, 0x2120, " ", "Broadcom 2045 Bluetooth 2.0 USB-UHE Device with trace filter" },
	{ 0x0A5C, 0x2121, " ", "Broadcom 2045 Bluetooth 2.0 USB Device with trace filter" },
	{ 0x0A5C, 0x2122, " ", "Broadcom Bluetooth 2.0+EDR USB dongle" },
	...
	{ 0x0A5C, 0x4502, " ", "USB Human Interface Device" },
	{ 0x0A5C, 0x4503, " ", "USB Human Interface Device" },
	...
	{ 0x168C, 0x001c, "USB\\VID_0000&PID_0000\5&1EA0B166&0&7 ", "VEN_8086&DEV_27DA&SUBSYS_200F17AA&REV_02" },
	{ 0x168C, 0x001C, "AR5BXB63", "WIFI CHIP from atheros" },
	...
	{ 0x1002, 0x4383, "AD1884", "ADI HD Audio" },
	...
	{ 0x1002, 0x4C66, "ATI MOBILITY RADEON 9000 (Microsoft Corporation -", "Radeon Mobility 9000 series" },
	...
	{ 0x1002, 0x5446, "ewmewm", "Video Controller (VGA Compatible)" },
	...
	{ 0x1002, 0x7104, " ", "ATI FireGL 7200 or 3200" },
	{ 0x1002, 0x7109, "R520", "Radeon X1800 Series" },
	{ 0x1002, 0x710F, "V7350", "ATI FireGL" },
	{ 0x1002, 0x7124, " ", "ATI FireGL 7200 or 3200" },
	{ 0x1002, 0x712F, "V 7350 Secondary", "ATI FireGL" },
	...
	{ 0x1002, 0x7942, "1002", "ATI XPress 1250M" },
	...
	{ 0x1002, 0x94CC, "ATI Radeon HD 4670 Series", "ATI Radeon HD 2400 Series" },
	...
	{ 0x1002, 0x9611, "780V", "ATI Radeon 3100 Graphics" },
	{ 0x1002, 0x9612, "3200", "ATI RADEON HD 3200 Graphics" },
	...
	{ 0x1033, 0x1033, "0720101gj", "universal serial bus controller" },
	...
	{ 0x1039, 0x7502, "649", "audio drivers" },
	...
	{ 0x104C, 0x803B, "PCI\\VEN_104C&DEV_803B&SUBSYS_81E6104D&REV_00 ", "Texas Instruments PCIxx12 Integrated FlashMedia Controller" },
	...
	{ 0x104C, 0xAC13, "PCI9440", "PCI\\VEN_104C&DEV_803B&SUBSYS_8212104D&REV_00\\4&6B16D5B&0&1AF0" },
	...
	{ 0x13F6, 0x0111, "CMI973x", "C-Media Audio Controller" },
	{ 0x13F6, 0x0112, "CMI-8378B/PCI-6CH", "PCI Audio Chip" },
	{ 0x13F6, 0x0211, "PCI\\VEN_13F6&DEV_0111&SUBSYS_011113F6&REV_10", "HSP56 MICROMODEM" },
	{ 0x13F6, 0x0300, "0x4005", "pci audio driver" },
	{ 0x13F6, 0x111, "PCI\\VEN_13F6&DEV_0111&REV_10", "C-Media Audio Controller" },
	...
	{ 0x109E, 0x0351, "B t878 khf", "tw card" },
	...
	{ 0x10B9, 0x10b9, "ALI M5273 A1", "0513 TS05 CKA90961000B" },
	...
	{ 0x10DE, 0x0006, "unknown", "realtec based HD Audio" },
	...
	{ 0x10DE, 0x0057, "nForce4 Ultra", "NVidia Network Bus Enumerator Description du périphérique	nVIDIA nForce4 SLI (CK8-04) - LAN Controll" },
	...
	{ 0x10DE, 0x0293, "0x0293", "NVIDIA GeForce 7900 GTX DUO" },
	...
	{ 0x10DE, 0x0402, "0407", "gainward bliss 8600 gt 512mo silent fx pcx" },
	{ 0x10DE, 0x0404, "G98", "GeForce 8400 GS" },
	...
	{ 0x10DE, 0x05E1, "GT200b", "GeForce GTX 280" },
	{ 0x10DE, 0x05E2, "GT200b", "GeForce GTX 260" },
	...
	{ 0x10DE, 0x0863, "GeForce 9x", "GeForce 9400M" },
	...
	{ 0x10E8, 0x4750, "S5920Q 0045 a009", "amcc PCI MatchMaker" },
	...
	{ 0x10E8, 0x8170, "S5933Q", "Matchmaker PCI Chipset Development Tool" },
	...
	{ 0x1106, 0x1106, "060000A1106	060000A ISA Bridge w/IDE", "ISA Bridge w/IDE" },
	...
	{ 0x13F0, 0x0200, "0x0200", "Encore ENL832-TX-ICNT Fast  Ethernet PCI Adapter" },
	...
	{ 0x14E4, 0x4315, "BCM1395", "Broadcom Wireless b/g" },
	...
	{ 0x1131, 0x7134, "SAA7130HL", "Tevion MD-9717 TV Tuner Card (TV7134RF)" },
	{ 0x1131, 0x7145, "d145ah", "ddddf" },
	{ 0x1131, 0x7146, "saa7135HL", "PCI\\VEN_1131&DEV7146" },
...
// Use this value for loop control during searching:
#define	PCI_DEV_IDS_LEN (sizeof(pci_dev_ids)/sizeof(pci_dev_id_record_t))
...
typedef struct {
	...
	char    *subclass_desc;
	char    *prog_if_desc;
} __attribute__((__packed__)) pci_class_id_record_t;

pci_class_id_record_t pci_class_ids[] = {
...
// Use this value for loop control during searching:
#define	PCI_CLASS_IDS_LEN (sizeof(pci_class_ids)/sizeof(pci_class_id_record_t))
